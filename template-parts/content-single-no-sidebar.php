			...
			<li class="post-category !m-0">
				...
				if ( is_array( $categories) || is_object( $categories )) {
					foreach ( $categories as $category ) {
						...
						echo '<span class="!mb-0"><a class="rounded-md text-xs font-normal bg-[#BB0000] hover:bg-red-800 visited:text-white uppercase py-1.5 px-4" href="' . esc_url( $category_link ) . '">' . $category->cat_name . '</a></span>';
					}
				}
