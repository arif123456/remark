...
<section class="no-results not-found bg-white pt-4 md:pt-8 lg:pt-8 pb-16 px-8 md:px-12 lg:px-12">
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'remark' ); ?></h1>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		elseif ( is_search() ) :
			...
			<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'remark' ); ?></p>
			<?php
			get_search_form();
