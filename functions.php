 ...
 */
function remark_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'remark_content_width', 640 );
}
add_action( 'after_setup_theme', 'remark_content_width', 0 );
 ...
 * Walker menu.
 */
require get_template_directory() . '/inc/class-remark-walker-menu.php';
